...
public class LoadReservationsDentalClinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_reservations_dental_clinic);
        //References
        refs();
        ...
        reservationsAdapter = new ReservationsAdapter(LoadReservationsDentalClinic.this, reservationsArrayList);
    ...
    private void refs(){
        imgBackBtn = findViewById(R.id.backBtnReservations);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(LoadReservationsDentalClinic.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
