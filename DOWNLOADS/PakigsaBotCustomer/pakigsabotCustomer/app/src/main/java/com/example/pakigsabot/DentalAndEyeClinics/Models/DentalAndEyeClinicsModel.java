package com.example.pakigsabot.DentalAndEyeClinics.Models;

public class DentalAndEyeClinicsModel {
    String est_id;
    String est_Name;
    String est_address;
    String est_image;
    ...
    public DentalAndEyeClinicsModel() {
        //empty constructor needed
    }

    public DentalAndEyeClinicsModel(String est_id, String est_Name, String est_address, String est_image, String est_phoneNum) {
        this.est_id = est_id;
