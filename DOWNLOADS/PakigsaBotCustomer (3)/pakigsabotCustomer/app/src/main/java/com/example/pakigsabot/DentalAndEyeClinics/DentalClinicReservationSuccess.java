...
public class DentalClinicReservationSuccess extends AppCompatActivity {

    //Initialize Variables
    MeowBottomNavigation bottomNavigation;
    ImageView backBtn;
    TextView gotoReservationTxt, gotoHelpCenterTxt, emailDentalClinicTxt;
    String estID, estName, estEmailAddress;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dental_clinic_reservation_success);
        ...
        emailDentalClinicTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                emailMessageScreen();
            }
    ...
    public void refs(){
        ...
        emailDentalClinicTxt = findViewById(R.id.emailDentalClinicTxt);
    }
