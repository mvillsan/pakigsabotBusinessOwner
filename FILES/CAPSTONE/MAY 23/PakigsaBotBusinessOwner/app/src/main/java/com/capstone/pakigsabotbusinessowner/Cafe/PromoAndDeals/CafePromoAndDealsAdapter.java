...
public class CafePromoAndDealsAdapter extends RecyclerView.Adapter<CafePromoAndDealsAdapter.MyViewHolder> {
    ...
    public CafePromoAndDealsAdapter(Context context, ArrayList<CafePromoAndDealsModel> cafePADArrayList) {
        this.context = context;
        this.cafePADArrayList = cafePADArrayList;
    ...
    @NonNull
    @Override
    public CafePromoAndDealsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull CafePromoAndDealsAdapter.MyViewHolder holder, int position) {
        ...
        CafePromoAndDealsModel cafePADList = cafePADArrayList.get(position);

        holder.name.setText(cafePADList.getCafePADName());
        holder.desc.setText(cafePADList.getCafePADDesc());
        holder.startDate.setText(cafePADList.getCafePADStartDate());
        holder.endDate.setText(cafePADList.getCafePADEndDate());
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Retrieving Data
                nameTxt.setText(cafePADList.getCafePADName());
                descTxt.setText(cafePADList.getCafePADDesc());
                startDateTxt.setText(cafePADList.getCafePADStartDate());
                endDateTxt.setText(cafePADList.getCafePADEndDate());
                ...
                updateBtnPopUp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(txtPADName.isEmpty() || txtPADDesc.isEmpty() || txtPADStartDate.isEmpty() || txtPADEndDate.isEmpty()){
                            ...
                            cafePAD.put("cafePADId", cafePADList.getCafePADId());


                            String userId = fAuth.getCurrentUser().getUid();
                            fStore.collection("establishments").document(userId).collection("cafe-promo-and-deals").document(cafePADList.getCafePADId()).set(cafePAD)
        ...
        //Delete from cafe-menu
        holder.delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(context)
                        .setTitle("DELETE PROCEDURE")
                        .setMessage("Do you want to Delete " + cafePADList.getCafePADName()+ "?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String userId = fAuth.getCurrentUser().getUid();
                                fStore.collection("establishments").document(userId).collection("cafe-promo-and-deals").document(cafePADList.getCafePADId())
                                        .delete()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                progressDialog.dismiss();
                                                Toast.makeText(context, cafePADList.getCafePADName() + " Successfully Deleted", Toast.LENGTH_SHORT).show();
                                                cafePADArrayList.remove(position);
