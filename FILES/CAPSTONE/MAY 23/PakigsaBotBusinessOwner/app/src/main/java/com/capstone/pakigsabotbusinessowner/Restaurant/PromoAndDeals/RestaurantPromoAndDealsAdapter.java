...
public class RestaurantPromoAndDealsAdapter extends RecyclerView.Adapter<RestaurantPromoAndDealsAdapter.MyViewHolder> {
    ...
    public RestaurantPromoAndDealsAdapter(Context context, ArrayList<RestaurantPromoAndDealsModel> restoPADArrayList) {
        this.context = context;
        this.restoPADArrayList = restoPADArrayList;
    ...
    public void onBindViewHolder(@NonNull RestaurantPromoAndDealsAdapter.MyViewHolder holder, int position) {
        //creating  object of RestaurantPromoAndDealsModel class and setting data to the textviews from the Restaurant PromoAndDealsModel class
       RestaurantPromoAndDealsModel restoPADList = restoPADArrayList.get(position);

        holder.name.setText(restoPADList.getRestoPADName());
        holder.desc.setText(restoPADList.getRestoPADDesc());
        holder.startDate.setText(restoPADList.getRestoPADStartDate());
        holder.endDate.setText(restoPADList.getRestoPADEndDate());
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Retrieving Data
                nameTxt.setText(restoPADList.getRestoPADName());
                descTxt.setText(restoPADList.getRestoPADDesc());
                startDateTxt.setText(restoPADList.getRestoPADStartDate());
                endDateTxt.setText(restoPADList.getRestoPADEndDate());
                ...
                updateBtnPopUp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(txtPADName.isEmpty() || txtPADDesc.isEmpty() || txtPADStartDate.isEmpty() || txtPADEndDate.isEmpty()){
                            ...
                            dentalPAD.put("restoPADName", txtPADName);
                            dentalPAD.put("restoPADDesc", txtPADDesc);
                            dentalPAD.put("restoPADStartDate", txtPADStartDate);
                            dentalPAD.put("restoPADEndDate", txtPADEndDate);
                            dentalPAD.put("restoPADId", restoPADList.getRestoPADId());


                            String userId = fAuth.getCurrentUser().getUid();
                            fStore.collection("establishments").document(userId).collection("resto-promo-and-deals").document(restoPADList.getRestoPADId()).set(restoPADList)
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(context)
                        ...
                        .setMessage("Do you want to Delete " + restoPADList.getRestoPADName()+ "?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String userId = fAuth.getCurrentUser().getUid();
                                fStore.collection("establishments").document(userId).collection("resto-promo-and-deals").document(restoPADList.getRestoPADId())
                                        .delete()
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                progressDialog.dismiss();
                                                Toast.makeText(context, restoPADList.getRestoPADName() + " Successfully Deleted", Toast.LENGTH_SHORT).show();
                                                restoPADArrayList.remove(position);
