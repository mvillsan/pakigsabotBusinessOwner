...
public class ViewReservationsEyeClinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservations_eye_clinic);
        ...
        reservationsAdapter = new ReservationsAdapter(ViewReservationsEyeClinic.this, reservationsArrayList);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationsEyeClinic.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
