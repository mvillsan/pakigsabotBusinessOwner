...
public class ViewReservationsResort extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_reservations_resort);
        ...
        reservationsAdapter = new ReservationsAdapter(ViewReservationsResort.this, reservationsArrayList);
    ...
    private void refs(){
        imgBackBtn = findViewById(R.id.backBtnLoadRResort);
    ...
    public void getReservationsList() {
        ...
        fStore.collection("reservations")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ViewReservationsResort.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
