...
import com.capstone.pakigsabotbusinessowner.Reservations.ViewReservationsDentalClinic;
        ...
        holder.details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                closeRHistoryDetails.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                         Intent in = new Intent(context.getApplicationContext(), ViewReservationsDentalClinic.class);
